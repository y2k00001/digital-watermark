package com.trace.core.exception;
...
public abstract class Assert {
     ...
     * @param responseEnum
     */
    public static void notEmpty(Integer n, ResponseEnum responseEnum) {
     ...
     * @param responseEnum
     */
    public static void notEmpty(BigDecimal n, ResponseEnum responseEnum) {
        if (n.compareTo(BigDecimal.ZERO)==0||n==null) {
            log.info("is empty...............");
            throw new BusinessException(responseEnum);
        }
    }
